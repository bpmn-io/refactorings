...
export default class RefactoringsContextPadProvider {
  constructor(contextPad, popupMenu, translate, refactorings) {
  ...
  getContextPadEntries(element) {
    ...
    return function(entries) {
      ...
      // Pre-fetch results:
      self.refactorings.getRefactorings([ element ]);
      ...
      return {
        ...
        alert: {
          ...
          html: `<div class="entry" title="${self._translate('Show suggestions')}">
