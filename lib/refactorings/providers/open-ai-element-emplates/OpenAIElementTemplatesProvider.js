...
* If the element's name does not seem to align with any predefined methods or services, don't suggest any tools.
* Not suggesting the wrong tools is more important than suggesting the right ones.
* Never explain the rationale behind selecting a particular tool; instead pass the confidence as the first argument when calling a tool.
